...
import { GetEventDetailByAdminService } from "./getEventDetailByAdmin.service";
import { JwtOptionalGuard } from 'src/shared/guard/jwt-optional.guard';
import { Response } from 'express';
import { ApiOperation, ApiQuery, ApiResponse, ApiTags, ApiBearerAuth } from '@nestjs/swagger';
import { ErrorHandler } from 'src/shared/exceptions/error.handler';
import { EventDetailResponse } from "./getEventDetailByAdmin-response.dto";
import { SlackService } from "src/infrastructure/adapters/slack/slack.service";

@ApiTags('Event Service - Event')
@Controller('api/admin/event/detail')
export class GetEventDetailByAdminController {
  constructor(
    private readonly slackService: SlackService,
    private readonly eventDetailService: GetEventDetailByAdminService) {}
